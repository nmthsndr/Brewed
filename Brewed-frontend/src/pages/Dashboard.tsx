  ...
  const featureCards = [
    {
      title: "Products",
      description:
        "Explore our complete collection of coffee and brewing essentials. Everything you need for the perfect coffee experience.",
      icon: IconCoffee,
      url: "/app/products",
    },
    {
    ...
    },
    {
      ...
      description: isLoggedIn
        ? "Track your orders in real-time, view past purchases, and review items."
        : "Sign in to your account to track orders, view past purchases, and review items.",
    ...
    <div style={{ position: 'relative' }}>
      ...
      <div className={classes.header}>
        ...
        <Text c="dimmed" ta="center" maw={600} mx="auto" mt="md" className={classes.description}>
          Premium coffee, brewing equipment, and barista essentials. Carefully selected and delivered to your door.
        </Text>
